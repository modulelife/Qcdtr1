...
#if defined(_MSC_VER)
#ifdef QCD_EXPORTS
#define QCD_API_ __declspec(dllexport)
#else
#define QCD_API_ __declspec(dllimport)
#endif
#define QCD_ALIGN8_ __declspec(align(8))
#else
#define QCD_API_ __attribute__((visibility("default")))
#define QCD_ALIGN8_ __attribute__((aligned(8)))
#endif
#endif
...
#define QCD_API_VERSION_PATCH 2
...
#ifdef __cplusplus
#define BEGIN_QCD_EXTERN_ extern "C" {
#define END_QCD_EXTERN_   }
#else
#define BEGIN_QCD_EXTERN_
#define END_QCD_EXTERN_
#endif
 ...
 */
QCD_API_ qcd_uint qcdQubitCapacity();

/**
 * Release the memory of quantum state if there is any
 *
 */
QCD_API_ void qcdClearBuffer();
 ...
 */
QCD_API_ void qcdNewCircuit(qcd_uint Circ_width);
 ...
 */
QCD_API_ qcd_uint qcdCurrentCircuitWidth();
 ...
 */
QCD_API_ void qcdNewSegment(qcd_uint* Segment_handle);
 ...
 * execution)
 */
QCD_API_ void qcdSubmitSegment(qcd_bool Enable_optimizer);
 ...
 */
QCD_API_ void qcdDeleteSegment(qcd_uint Segment_handle);
 ...
 */
QCD_API_ void qcdGate(qcd_enum Gate_type, qcd_uint Target_qubit);
 ...
 */
QCD_API_ void qcdControlGate(qcd_enum Gate_type, qcd_uint Target_qubit,
 ...
 */
QCD_API_ void qcdMultiControlGate(qcd_enum Gate_type, qcd_uint Target_qubit,
 ...
 */
QCD_API_ void qcdRotationGate(qcd_enum Gate_type, qcd_uint Target_qubit,
	double Angle);
 ...
 * @param Control_value: True control or false control
 */
QCD_API_ void qcdControlRotationGate(qcd_enum Gate_type, qcd_uint Target_qubit,
 ...
 * @param Ctrl_list_len: Number of control bits
 */
QCD_API_ void qcdMultiControlRotationGate(qcd_enum Gate_type,
 ...
 */
QCD_API_ void qcdSwapGate(qcd_uint Target_qubit1, qcd_uint Target_qubit2);
 ...
 * @param Control_qubit: The control qubit index
 */
QCD_API_ void qcdCNOTGate(qcd_uint Target_qubit, qcd_uint Control_qubit);
 ...
 * @param Control_qubit: The control qubit index
 */
QCD_API_ void qcdCZGate(qcd_uint Target_qubit, qcd_uint Control_qubit);
...
* @param Lambda
*/
QCD_API_ void qcdU1Gate(qcd_uint Target_qubit, double Lambda);
...
* @param Lambda
*/
QCD_API_ void qcdU2Gate(qcd_uint Target_qubit, double Phi, double Lambda);
...
* @param Lambda
*/
QCD_API_ void qcdU3Gate(qcd_uint Target_qubit, double Theta, double Phi,
	double Lambda);
...
* @param Control_value: True control or false control
*/
QCD_API_ void qcdControlU1Gate(qcd_uint Target_qubit, double Lambda,
	qcd_uint Control_qubit, qcd_bool Control_value);
...
* @param Control_value: True control or false control
*/
QCD_API_ void qcdControlU2Gate(qcd_uint Target_qubit, double Phi, double Lambda,
	qcd_uint Control_qubit, qcd_bool Control_value);
 ...
 *@param Control_value: True control or false control
*/
QCD_API_ void qcdControlU3Gate(qcd_uint Target_qubit, double Theta, double Phi,
...
* @param Ctrl_list_len: Number of control bits
*/
QCD_API_ void qcdMultiControlU1Gate(qcd_uint Target_qubit, double Lambda,
	const qcd_uint* Control_qubits, const qcd_bool* Control_values,
	qcd_uint Ctrl_list_len);
...
* @param Ctrl_list_len: Number of control bits
*/
QCD_API_ void qcdMultiControlU2Gate(qcd_uint Target_qubit, double Phi,
 ...
 *@param Ctrl_list_len: Number of control bits
*/
QCD_API_ void qcdMultiControlU3Gate(qcd_uint Target_qubit, double Theta,
 ...
 * @param Probability: 
 */
QCD_API_ void qcdUnitaryNoise(qcd_enum Noise_type, qcd_uint Target_qubit, double Probability);
 ...
 *
 */
QCD_API_ void qcdZeroStateInit();

/**
 * Initialize quantum state to a Haar random state
 *
 */
QCD_API_ void qcdHaarRandomInit();
 ...
 */
QCD_API_ void qcdBitsetInit(qcd_ullong Bitset);
 ...
 */
QCD_API_ void qcdExecuteSegment(qcd_uint Segment_handle);
 ...
 */
QCD_API_ qcd_ullong qcdGetStateDim();
 ...
 */
QCD_API_ double qcdGetQubitProbabilityZero(qcd_uint Qubit_index);
 ...
 * @return the probability
 */
QCD_API_ double qcdGetBaseProbability(qcd_ullong Base_vector_index);
 ...
 */
QCD_API_ qcd_complex qcdGetBaseComponent(qcd_ullong Base_vector_index);
 ...
 * @return error code
 */
QCD_API_ qcd_enum qcdGetError();


/**
 * Clears the error state for the current thread
 */
QCD_API_ void qcdClearError();
